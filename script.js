...
document.addEventListener('DOMContentLoaded', function(){
  ...
  if(homeBtn){ homeBtn.addEventListener('click', ()=>{ try{ if(bgMusic){ bgMusic.pause(); bgMusic.currentTime=0; } }catch(e){}; if(gameRoot) gameRoot.classList.add('hidden'); if(splash) { splash.classList.remove('hidden'); splash.classList.add('show'); } }); }
